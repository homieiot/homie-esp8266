...
#### void Homie.setGlobalInputHandler (bool (\*`handler`)(String `node`, String `property`, String `value`))
...
#### void HomieNode (const char\* `id`, const char\* `type`, bool (\*`handler`)(String `property`, String `value`) = )
...
#### void .subscribe (const char\* `property`, bool (\*`handler`)(String `value`) = )
