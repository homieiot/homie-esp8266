...
public:
  ...
  void settable(const PropertyInputHandler &inputHandler)
  {
    _settable = true;
...
protected:
  ...
  virtual bool handleInput(const char *topic, const char *playload) { return true; }
